  ...
  const menuItems = [
    {
      ...
      icon: Users,
      path: '/tenant-dashboard/learners',
    },
    {
      id: 'courses',
      label: 'Course Assignment',
      icon: BookOpen,
      path: '/tenant-dashboard/courses',
    },
    {
      id: 'branding',
      label: 'Local Branding',
      icon: Palette,
      path: '/tenant-dashboard/branding',
    },
    {
      id: 'storage',
    ...
    },
    {
      ...
      icon: FileCheck,
      path: '/tenant-dashboard/compliance',
    },
    {
      id: 'audit',
      label: 'Audit Trail',
      icon: FileText,
      path: '/tenant-dashboard/audit',
    },
  ];
          ...
          <div className="p-4 border-t border-gray-200 flex-shrink-0">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-500 truncate">Tenant Admin</p>
              </div>
              <button
        ...
        <header className="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-4 lg:px-6">
          ...
          <div className="flex items-center gap-3 ml-4">
            <div className="hidden sm:flex flex-col items-end">
              ...
              <span className="text-xs text-gray-500">Tenant Admin</span>
            </div>
            {user.profilePicture ? (
              <img
                src={user.profilePicture}
